...
class DropDownModal extends PureComponent {
  static propTypes = {
     ...
     */
    onOptionSelected: PropTypes.func, // eslint-disable-line
    /**
     ...
     */
    valueProperty: PropTypes.string.isRequired, // eslint-disable-line
    /**
  ...
  emitOnOptionSelectedEvent(option) {
    const onOptionSelected = _.get(this.props, 'onOptionSelected');
  ...
  close() {
    const onClose = _.get(this.props, 'onClose');
