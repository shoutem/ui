...
import addEvent from "./add-event.svg";
...
export const Icons = {
  ...
  "add-to-favorites-off": addToFavoritesOff,
  addToFavoritesOn: addToFavoritesOn,
  address: address,
  back: back,
  books: books,
  call: call,
  ...
  products: products,
  radio: radio,
  "radiobutton-off": radiobuttonOff,
  "radiobutton-on": radiobuttonOn,
  receipt: receipt,
  refresh: refresh,
